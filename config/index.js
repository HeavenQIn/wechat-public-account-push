export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx872bd2a523bd2b73",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5a4e3e6f9316674129724ed87d23f8fd",
  ...
  USERS: [wonder_IX_141_tsu]
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "--v5NN02uHswOM7HV3a6XgfKpjlGKJTJmnYSINAdqTA",
      // 所在省份
      province: "贵州",
      // 所在城市
      city: "贵阳",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "向日葵", "year": "2000", "date": "12-25"},
  ...
  CALLBACK_TEMPLATE_ID: "--v5NN02uHswOM7HV3a6XgfKpjlGKJTJmnYSINAdqTA",
